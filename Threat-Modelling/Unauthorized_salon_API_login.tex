...
\begin{forest}
[Unauthorized\\
Salon API Login, proTree
  [Attacker steals salon\\
user login API credentials, proTree]
  [Attacker accesses API\\
resources using stolen\\
user\textquotesingle{}s access credentials, proTree]
  [Record salon users last login information\\
and IP address, oppTree
    [Display user\textquotesingle{}s last login\\
information in post-login\\
API homepage/screen]
  ]
]\andC
\end{forest}
