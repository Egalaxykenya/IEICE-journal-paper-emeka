...
violation, proTree
  [Salon customer\\
modifies salon\textquotesingle{}s\\
business profile, proTree
    [Salon customer logs\\
into salon booking system
      [Salon customer creates\\
an account in salon booking\\
system]
    ]
    [Salon customer\\
requests API to view\\
salon business profile]
    [Salon customer\\
edits salon business\\
profile]
  ]\andN
  [Implement access controls\\
that strictly defines allowable actions\\
of salon owners and salon customers, oppTree]
]
\end{forest}
\end{document}
