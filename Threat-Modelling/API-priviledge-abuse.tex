...
\begin{document}
\begin{forest}
[API priviledge abuse, proTree
  [Salon customer authenticates\\
and login to salon\textquotesingle{}s API client\\
application, proTree]
  [Salon customer perform\\
interactions on priviledged\\
Salon API endpoints, proTree]
  [Assign user priviledges to\\
user IDs not authentication\\
information, oppTree
    [Enforce role based access when interacting with\\
priviledged salon API end points]
  ]
]\andC
\end{forest}
\end{document}
