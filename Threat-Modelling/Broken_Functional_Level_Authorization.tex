...
\begin{forest}
[Broken Function\\
Level Authorization, proTree
  [Unauthorized Access\\
to an API Functionality\\
of Another Priviledged Role, proTree
    [Access/Use API Functionality\\
of User\textquotesingle{}s role
      [Registered API User]
      [Valid API\\
Access Credentials]
    ]\andN
    [Access/Use API functionality\\
of another priviledged role]
  ]\andN
  [Restrict Relevant HTTP methods\\
for Specific User Roles, oppTree
