...
\begin{forest}
[Negative service\\
quantity booking, proTree
  [User completes\\
service booking, proTree
    [User logs in to salon\\
booking system
      [User creates an\\
account in salon\\
booking system]
...
service to book]
    [User books service\\
and adds negative quantity]
  ]\andN
  [Use domain primitive that\\
strictly defines a correct\\
service quantity in context\\
of OSBS, oppTree]
]
\end{forest}
\end{document}
